...
| 1 | LinK01 | A+B | 输入输出 |
| 2 | LinK02 | 完美立方 | 枚举 |
| 3 | LinK03 | 人的周期 | 枚举/中国剩余定理 |
| 4 | LinK04 | 排序考试 | STL排序 |
| 5 | LinK05 | 假币问题 | 枚举+验证 |
| 6 | LinK06 | 两数之和 | 哈希/双指针 |
| 7 | LinK07 | 三数之和 | 排序+双指针 |
| 8 | LinK08 | 四数之和 | 排序+双指针 |
| 9 | LinK09 | 汉诺塔I | 递归 |
| 10 | LinK10 | 汉诺塔II | 递归 |
| 11 | LinK11 | DFS试炼之排列数字 | DFS全排列 |
| 12 | LinK12 | 字符全排列 | DFS全排列 |
| 13 | LinK13 | 输出N皇后的全部摆法 | DFS回溯 |
| 14 | LinK14 | 求八皇后的第n种解 | DFS回溯 |
| 15 | LinK15 | 爬天梯 | DP/斐波那契 |
| 16 | LinK16 | 放苹果 | 递归/DP |
| 17 | LinK17 | 递归求波兰表达式 | 递归 |
| 18 | LinK18 | 2的幂次方表示 | 递归 |
| 19 | LinK19 | 递归实现指数型枚举 | DFS |
| 20 | LinK20 | 递归实现组合型枚举 | DFS |
| 21 | LinK21 | 递归实现排列型枚举 | DFS |
| 22 | LinK22 | 算术表达式 | 栈/中缀求值 |
| 23 | LinK23 | 二进制密码锁 | 贪心/枚举 |
| 24 | LinK24 | 熄灯问题 | 枚举/模拟 |
| 25 | LinK25 | 拨钟问题 | 枚举 |
| 26 | LinK26 | 算24 | DFS |
| 27 | LinK27 | 大数排序 | 自定义排序 |
| 28 | LinK28 | 快速选择第k个数 | 快选/分治 |
| 29 | LinK29 | 输出前k大的数 | 堆/Top-K |
| 30 | LinK30 | 归并排序 | 分治 |
| 31 | LinK31 | 求排列的逆序数 | 归并/逆序对 |
| 32 | LinK32 | 查找指定数 | 二分查找 |
| 33 | LinK33 | 攻击范围 | 二分查找 |
| 34 | LinK34 | 求方程的根 | 二分 |
| 35 | LinK35 | 数的三次方根 | 浮点二分 |
| 36 | LinK36 | 最小预算值 | 二分答案 |
| 37 | LinK37 | 林克的蛋糕 | 二分答案 |
| 38 | LinK38 | 林克的命运之阵 | DP/递推 |
| 39 | LinK39 | 净化迷雾森林 | BFS/DFS |
| 40 | LinK40 | 骑士林克的怜悯(1) | 骑士巡游/回溯 |
| 41 | LinK41 | 英杰们的蛋糕塔 | DFS+剪枝 |
| 42 | LinK42 | 击杀黄金蛋糕人马 | DFS/DP |
| 43 | LinK43 | 求二进制中1的个数 | 位运算/lowbit |
| 44 | LinK44 | 最低位1位置 | 位运算/打表 |
| 45 | LinK45 | 真假记忆碎片 | 数独验证 |
| 46 | LinK46 | 寻找林克的回忆(1) | 数独求解/回溯 |
| 47 | LinK47 | 寻找林克的回忆(2) | 数独变体/回溯 |
| 48 | LinK48 | 寻找林克的回忆(3) | 数独优化/MRV |
| 49 | LinK49 | 寻找林克的回忆(4) | 大数独/回溯 |
| 50 | LinK50 | 寻找林克的回忆(5) | 数独/位运算优化 |
